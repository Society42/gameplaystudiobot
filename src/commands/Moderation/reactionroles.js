...
module.exports = {
    ...
    async execute (interaction, client) {
        ...
        collector.on('collect', async (i) => {
            ...
            if (i.guild.members.me.roles.highest.positions < role1.position) {
            ...
            if (i.guild.members.me.roles.highest.positions < role2.position) {
                i.update({ content: "My role is below the roles that I'm trying to give; I have shut this reaction role message down", ephemeral: true});
                return;
            }
            if (i.guild.members.me.roles.highest.positions < role3.position) {
                i.update({ content: "My role is below the roles that I'm trying to give; I have shut this reaction role message down", ephemeral: true});
                return;
            }
